...
class _SignupScreenState extends ConsumerState<SignupScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final ok = await ref.read(authServiceProvider).signUp(
      ...
      if (ok) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text(
              'Could not sign in yet. If email confirmation is enabled in Supabase, check your inbox. Otherwise try again.',
            ),
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'OR',
                        style: TextStyle(color: AppTheme.surfaceVariant, fontSize: 13, fontWeight: FontWeight.w600),
                      ),
                    ),
                    Expanded(child: Divider(color: AppTheme.onSurfaceVariant.withValues(alpha: 0.35))),
                  ],
